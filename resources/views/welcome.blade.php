...
<body class="leading-normal tracking-normal text-white bg-primary " style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
                            ...
                            @if (Route::has('register'))
                                <li class="mr-3">
                                    <a href="{{ route('register') }}"
                                        class="font-semibold text-gray-200 hover:text-gray-400 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
                                </li>
                            @endif
                        @endauth
                    @endif
        ...
        {{-- <hr class="border-b-2 border-secondary opacity-25 my-0 py-0" /> --}}
    </nav>
    <!--Hero-->
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="w-full">
                ...
                <img src="{{ asset('LOGO PRIMARIA FUNDO TRANSPARENTE.svg') }}" alt="" class="w-full px-24">
            </div>
        </div>
    </div>
    <div class="relative bg-primary mt-6 mx-6">
    ...
    <hr class="border-b-2 border-secondary border-dashed opacity-75 my-0 py-0" />
    {{-- SVG --}}
    ...
    <section class="bg-secondary border-b-2 border-dashed py-32">
        <div class="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:mx-48 font-medium text-xl text-primary mb-6">
            ...
            <div class="grid grid-cols-3 gap-3">
                <div class="text-white bg-primary text-center py-6 px-2 rounded-2xl">
                    <x-icon name="bookmark-alt" class="w-40 h-40 my-6 mx-auto justify-center" />
                    <p class="text-center font-extrabold text-2xl mb-6">FORMAÇÂO</p>
    ...
    {{-- contato --}}
    <section class="bg-secondary border-b border-dotted py-32">
        <div class="container max-w-5xl mx-auto m-8">
